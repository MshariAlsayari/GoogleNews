...
public class BusinessTab extends Fragment {
    ...
    List<Source> sourcesWithSpecificCategory = new ArrayList<>();
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        Call<Category> connection = categoryApi.getchannelNewsWithCategory("business");
            ...
            public void onResponse(Call<Category> call, Response<Category> response) {
                ...
                if (sources.size() != 0) {
                    ...
                    if (sourcesWithSpecificCategory.size() != 0) {
                        ...
                        Toast.makeText(getContext(), "There are no business news", Toast.LENGTH_LONG).show();
                    }
                } else {
                    Toast.makeText(getContext(), "There are no business news", Toast.LENGTH_LONG).show();
                }
