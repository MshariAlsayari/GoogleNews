...
public class EntertainmentTab extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        Call<Category> connection = categoryApi.getchannelNewsWithCategory("entertainment");
            ...
            public void onResponse(Call<Category> call, Response<Category> response) {
                ...
                if (sources.size() != 0) {
                    ...
                    if (sourcesWithSpecificCategory.size() != 0) {
                        ...
                        Toast.makeText(getContext(), "There are no entertainment news", Toast.LENGTH_LONG).show();
                    }
