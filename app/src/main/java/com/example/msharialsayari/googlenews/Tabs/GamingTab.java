...
public class GamingTab extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        Call<Category> connection = categoryApi.getchannelNewsWithCategory("gaming");
            ...
            public void onResponse(Call<Category> call, Response<Category> response) {
                ...
                if (sources.size() != 0) {
                    ...
                    if (sourcesWithSpecificCategory.size() != 0) {
                        ...
                        Toast.makeText(getContext(), "There are no gaming news", Toast.LENGTH_LONG).show();
                    }
                } else {
                    Toast.makeText(getContext(), "There are no gaming news", Toast.LENGTH_LONG).show();
                }
