...
public class TechnologyTab extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        Call<Category> connection = categoryApi.getchannelNewsWithCategory("technology");
            ...
            public void onResponse(Call<Category> call, Response<Category> response) {
                ...
                if (sources.size() != 0) {
                    ...
                    if (sourcesWithSpecificCategory.size() != 0) {
                        ...
                        Toast.makeText(getContext(), "There are no technology news", Toast.LENGTH_LONG).show();
                    }
                } else {
                    Toast.makeText(getContext(), "There are no technology news", Toast.LENGTH_LONG).show();
                }
